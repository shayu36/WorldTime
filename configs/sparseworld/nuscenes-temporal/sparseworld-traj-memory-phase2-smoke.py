_base_ = ['./sparseworld-traj-memory-phase2.py']

# Short user-run connectivity and frozen-state gate for phase2 fine-tuning.
...
optimizer_config = dict(
    _delete_=True,
    type='QueryMemoryPhase2ConnectivityOptimizerHook',
